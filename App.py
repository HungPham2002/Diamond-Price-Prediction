...
model = joblib.load('trained model\linear_regression_model_Scikit.pkl')
...
def predict(carat, cut, color, clarity, depth, table, x, y, z):
    ...
    input = np.array([[carat, cut, color, clarity, depth, table, x, y, z,0.0]], dtype='float')
...
if st.button('Predict Price'):
    out = predict(carat, cut, color, clarity, depth, table, x, y, z)
